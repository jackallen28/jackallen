"""
Dual-start metric thread test piece — male (external)
  Flange:      OD=20mm, H=3mm, Z=0..3  (grip/reference surface)
  Shaft:       OD=14.2mm (major), H=12mm, Z=3..15
  Thread:      2-start RH, pitch=1.5mm, lead=3.0mm, 60 deg profile
               Major (crest) = 14.2mm, minor (root) = 12.5mm
               Depth = 0.85mm, full shaft length
...
def gen_step():
    ...
    result.label = "dual_start_thread_male"
    return result
